            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Enregister une commande</h4>
                    </div>
                    <div class="card-body">

                        <form class="needs-validation" novalidate action="{{ route('livraisons.store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="user_id" id="user_id" value="1">
                            <input type="hidden" name="fournisseur_id" id="fournisseur_id" value="1">
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <input class="form-control input-default" type="number" name="prixUnitaire"
                                            id="prixUnitaire" placeholder="Prix Unitaire" value="{{ old('prixUnitaire') }}"
                                            required />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <input class="form-control input-default" type="number" name="quantiteAchat"
                                            id="quantiteAchat" placeholder="Quantité" value="{{ old('quantiteAchat') }}"
                                            required />
